...
const CivilMainHome =()=>{
    return(
        ...
        <section>
        <div classNameName="video-banner">
          <video autoplay="" muted="" loop="" id="myVideo">
            <source src="https://mitra.ac.in/uploads/about-dept/civil.mp4" type="video/mp4"/>
          </video>
          <div classNameName="content video-overlay">
    ...
    <h2 classNameName="faculty-title mt-3 text-center">About Civil Engineering</h2>

    <div classNameName="row">
      <div classNameName="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        <div id="carouselExampleIndicators" classNameName="carousel slide" data-bs-ride="carousel">
          <div classNameName="carousel-indicators">
            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" classNameName="active"
          ...
          <div classNameName="carousel-inner">
            <div classNameName="carousel-item active">
              <img src="https://mitra.ac.in/assets/site/dummy/sl1.jpg" classNameName="d-block w-100 height-400" alt="..."/>
            </div>
            <div classNameName="carousel-item">
              <img src="	https://mitra.ac.in/assets/site/dummy/sl2.jpg" classNameName="d-block w-100 height-400" alt="..."/>
            </div>
            <div classNameName="carousel-item">
              <img src="https://mitra.ac.in/assets/site/dummy/sl3.jpg" classNameName="d-block w-100 height-400" alt="..."/>
            </div>
          </div>
          <button classNameName="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators"
            data-bs-slide="prev">
            <span classNameName="carousel-control-prev-icon" aria-hidden="true"></span>
            <span classNameName="visually-hidden">Previous</span>
          </button>
          <button classNameName="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators"
            data-bs-slide="next">
...
<div className="container">
    ...
    <div className="col-md-6">
      <div className="boxed-feature mission">
        ...
        <div className="textwidget">
          <marquee className="ntboard" direction="up" scrolldelay="150" height="450px" onmouseover="this.stop();" onmouseout="this.start();">
                            <ul>
                            
                                                            <li><a style={{color:'#230000'}} href="http://prmitr.mastersofterp.in/" target="_blank">
                                <p className="text text-justify">ERP Login</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/uploads/main-media-pdf/Admission_to_Master.PDF" target="_blank">
                                <p className="text text-justify">Admission to Master of Engineering</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="http://mitra.ac.in/admissions/phd" target="">
                                <p className="text text-justify">Ph.D Admissions 2022-23</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="http://mitra.ac.in/uploads/main-media-pdf/7.pdf" target="_blank">
                                <p className="text text-justify">Three Programs / Courses (Mechanical, Electronics &amp; Telecom. and Civil Engineering) of PRMIT&amp;R has been accredited by NBA till 30-June-2022</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="http://mitra.ac.in/site/view-page/higher-className-admission-2022-2023_26" target="">
                                <p className="text text-justify">Links and Notice for Admission to Higher Classes</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://www.onlinesbi.com/sbicollect/icollecthome.htm" target="_blank">
                                <p className="text text-justify">Know &amp; Pay your College Fees &amp; Other Fees Online</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/uploads/dept-pdf/ARIIA_Report_2021-C-43072.pdf" target="_blank">
                                <p className="text text-justify">ARIIA 2021</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://www.aicte-india.org/feedback/index.php" target="_blank">
                                <p className="text text-justify">Feedback of Student and Faculty at AICTE</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/old/wp-content/uploads/2017/08/Notice-Crubbing-Ragging.pdf" target="_blank">
                                <p className="text text-justify">PUBLIC NOTICE ON MENACE OF RAGGING</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="http://mitra.ac.in/uploads/main-media-pdf/Full_Report_IR-2023_Prof__Ram_Meghe_Institute_of_Technology___Research.pdf" target="_blank">
                                <p className="text text-justify">NIRF</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/naac-self-study-report/" target="_blank">
                                <p className="text text-justify">NAAC Self Study Report &amp; IQAC-AQAR</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://accounts.google.com/AddSession?hd=mitra.ac.in&amp;sacu=1#identifier" target="_blank">
                                <p className="text text-justify">Webmail Login</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/site/alumni" target="">
                                <p className="text text-justify">Institute Alumni Council</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/admissions/academic" target="">
                                <p className="text text-justify">Academic Calendar</p></a></li><br/>
                                                            <li><a style={{color:'#230000'}} href="https://mitra.ac.in/old/wp-content/uploads/2020/05/Anti_Ragging_Committee_2020.pdf" target="_blank">
                                <p className="text text-justify">Prevention and Prohibition of Ragging</p></a></li><br/>
  ...
  <div className="textwidget">
   <ul>
                    <li><a href="#" style={{color:"red"}}>No important links found..</a></li> <br/>
