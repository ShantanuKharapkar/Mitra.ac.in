        ...
        <div className="fullwidth-block greet-section">
          <div className="container">
            ...
            <table className="table table-bordered table-striped" xss="removed">
              <tbody>
                <tr xss="removed">
                  <th width="400" xss="removed">Program of Study</th>
                  <th width="400" xss="removed">Description</th>
                </tr>
                <tr>
                  <td rowspan="3" xss="removed">
                    B.E. (Information Technology)
                  </td>
                  <td xss="removed">Started with 60 seats in 2000-2001</td>
                </tr>
                <tr xss="removed">
                  <td xss="removed">Intake increased to 90 in 2008-2009</td>
                </tr>
                <tr>
                  <td xss="removed">Intake increased to 120 in 2012-2013</td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="container">
            ...
            <div>
              <h2 className="faculty-title">
                <div>
                  <strong
                    >Post Graduate:- Master of Engineering in Information
                    Technology</strong
                  >
                </div>
                <div className="clear" xss="removed"></div>
...
export default ElectroProgramme;